"""
Django settings for SAPbot project.
...
SECRET_KEY = 'django-insecure-u^y5ijw9fa58o%fj4ud+b41kpa2gssy(5%bzt7yjs0%teh7b5^'
...
WSGI_APPLICATION = 'SAPbot.wsgi.application'
